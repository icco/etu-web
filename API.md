...
**REST API (JSON+HTTP)** - Standard HTTP REST API with JSON payloads
...
API types are formally defined using Protocol Buffers in `proto/etu.proto`. These definitions provide a language-agnostic schema for the API data structures and can be used for code generation, validation, and documentation.
