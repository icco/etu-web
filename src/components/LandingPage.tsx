...
import { NotePencil, MagnifyingGlass, DeviceMobile, Code } from '@phosphor-icons/react'
    ...
    <div className="min-h-screen bg-background">
      <header className="border-b border-border bg-card/50 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <Button onClick={onGetStarted} className="bg-accent text-accent-foreground hover:bg-accent/90">
            Get Started
          </Button>
        </div>
      </header>
      ...
      <section className="container mx-auto px-6 py-20 md:py-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 leading-relaxed max-w-2xl mx-auto">
            ...
            and seamless access across all your devices.
          </p>
          <Button 
      ...
      <section className="container mx-auto px-6 py-20">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-center text-sm text-muted-foreground mt-6">
            Self-hosting coming soon. Follow progress on{' '}
            <a href="https://github.com/icco/etu" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline">
              GitHub
            </a>
          </p>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-muted-foreground">
                © 2024 Etu. Open source journaling.
              </span>
            </div>
            <div className="flex gap-6 text-sm">
              <a href="https://github.com/icco/etu" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-accent transition-colors">
                GitHub
              </a>
              <a href="https://writing.natwelch.com/post/765" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-accent transition-colors">
                Blog Post
              </a>
              <a href="https://github.com/icco/etu-mobile" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-accent transition-colors">
                Mobile App
              </a>
            </div>
          </div>
